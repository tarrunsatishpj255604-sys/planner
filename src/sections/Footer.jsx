    ...
    <footer className="footer">
      <div className="container">
        <div className="footer-grid">
          <div>
            ...
            <p className="footer-tag">
              A modern all-in-one study planner for students. Organise subjects,
              tasks, exams, notes, goals and productivity from one beautiful,
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><a href="#download">Help centre</a></li>
        ...
        <div className="footer-bottom">
          <span>© {new Date().getFullYear()} Study Planner. All rights reserved.</span>
          <div className="socials">
            <a href="#download" aria-label="Twitter">
              <Social d="M23.95 4.57a10 10 0 0 1-2.82.77 4.96 4.96 0 0 0 2.16-2.72c-.95.56-2 .97-3.12 1.19a4.92 4.92 0 0 0-8.39 4.48A13.94 13.94 0 0 1 1.64 3.16a4.92 4.92 0 0 0 1.52 6.57c-.8-.03-1.55-.25-2.2-.62v.06a4.92 4.92 0 0 0 3.95 4.83 4.9 4.9 0 0 1-2.22.08 4.93 4.93 0 0 0 4.6 3.42A9.87 9.87 0 0 1 0 19.54a13.94 13.94 0 0 0 7.55 2.21c9.06 0 14.01-7.5 14.01-14.01 0-.21 0-.43-.02-.64a10 10 0 0 0 2.45-2.54z" />
            </a>
            <a href="#download" aria-label="Instagram">
            ...
            <a href="#download" aria-label="Discord">
